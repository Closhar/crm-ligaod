...
const api_addr = api + '/api/series-types';

useSeoMeta({
  title: ((params.value as any).adminka_name || 'Админка') + ' - Типы серий',
  description: 'Управление типами серий',
});

const p_icon = "fluent:document-queue-24-filled";
const p_description = 'Типы серий';
const breadcrumbs = [
  {
    id: 1,
    title: 'Система',
...
const formOptions = ref({
  ...
  formTitle: 'Добавление типа серии',
  hideButtons: false,
  ...
  columns: [
    {
      ...
      options: {
        readonly: false,
        placeholder: 'Название типа серии',
        hint: 'Полное название типа серии',
    ...
    },
    {
      ...
      options: {
        ...
        hint: 'Сокращенное название типа серии',
        cellClass: 'text-xs font-bold bg-gray-100 rounded text-gray-800 border px-1 w-full',
        inputClass: 'w-full p-1 h-10 border border-gray-300 rounded text-md'
      }
    }
