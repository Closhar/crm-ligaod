<template>
  <div v-if="props.column?.options?.relationField" class="kirh-has-many-select-field">
...
const handleClickOutside = (event: Event) => {
  ...
  const fieldContainer = target.closest('.kirh-has-many-select-field');
