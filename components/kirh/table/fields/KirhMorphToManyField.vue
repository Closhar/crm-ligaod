<template>
  <div v-if="props.column?.options?.relationField" class="kirh-morph-to-many-field">
...
const handleClickOutside = (event: Event) => {
  ...
  const fieldContainer = target.closest('.kirh-morph-to-many-field');
