...
const show_breadcrumbs = props.show_breadcrumbs === 'true'
...
<template>
  <div class="flex-1">
    ...
    <!-- Breadcrumbs -->
    <nav v-if="show_breadcrumbs" class="flex bg-gray-50 px-3 py-2 rounded-md border border-gray-100">
      <ol class="flex items-center space-x-2 text-sm">
        ...
        <li v-for="b in breadcrumbs" v-if="breadcrumbs" :key="b.id" class="flex items-center">
    ...
    <!-- Блок с заголовком -->
    <div v-if="title" class="flex justify-between p-2">
      <h1 class="text-2xl font-semibold text-gray-800">
        <Icon v-if="icon" :name="icon" class="mr-2" size="1em"/>
